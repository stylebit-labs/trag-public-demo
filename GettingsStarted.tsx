...
import { FRONT_VERSION, GITHUB_APP } from "@utils/consts";
import { Terminal, TerminalTag } from "iconoir-react";
...
const GettingStarted = () => {
	...
	const selectRepo = useCallback((repoInfo: SingleRepo) => {
		setPickedRepos((currentRepos) => {
			const alreadySelected = currentRepos.find((r) => r.repo === repoInfo.repo);
			if (alreadySelected) {
				// remove
